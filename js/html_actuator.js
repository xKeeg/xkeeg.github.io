...
HTMLActuator.prototype.addTile = function (tile, override = false) {
  var self = this;
  ...
  if (tile.value < 2048) {
    var urlpath = "url(img/" + tile.value + ".png)";
    element.style.background = urlpath;
  } else {
    var urlpath = "url(img/" + 2048 + ".png)";
    element.style.background = urlpath;
  }
...
HTMLActuator.prototype.showLoading = function () {
